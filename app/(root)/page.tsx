...
export const metadata: Metadata = {
  ...
  description:
    "Ashish Raj - Applied Software Engineer working at the intersection of AI, data, and scalable software systems. Explore my projects, experience, and contributions.",
  alternates: {
...
export default function IndexPage() {
  ...
  const personSchema = {
    ...
    jobTitle: "Applied Software Engineer",
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            width={100}
            sizes="100vw"
            className="bg-primary rounded-full mb-0 h-auto md:mb-2 w-[60%] max-w-[16rem] border-4 border-primary"
            alt="Ashish Raj - Applied Software Engineer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
